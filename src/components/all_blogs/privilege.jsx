...
We all know what privilege means in the materialistic sense. But what does it mean, psychologically or philosophically? Let me give it a try; Privilege is the removal or absence of certain barriers, created with capitalism. This definition makes sense without the word capitalism too. But before capitalism, it was referred to as a class system, not privilege. It could be also stated as the set of benefits received without efforts. It is the rope, the harness, in your rock climbing. The safety net to fall onto, bringing the risk close to zero. And when you are minimizing the risk that means you are leveraging the pool of resources you were granted.
...
<br />
<br />
<h4 className='strong' style={{fontWeight: "bold"}}>Scarcity creates a negative feedback loop</h4>
