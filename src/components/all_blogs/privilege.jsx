...
We all know what privilege means in the materialistic sense. But what does it means, psychologically or philosophically? Let me give it a try, privilege is the removal or absence of certain barriers, created with capitalism. This definition makes sense without the word capitalism also. But before capitalism, it was referred to as class system, not privilege. It could be also stated as the set of benefits received without efforts. It is the rope, the harness, in your rock climbing. The safety net to fall onto, bringing the risk close to zero. And when you are minimizing the risk that means you are leveraging the pool of resources you were granted.
.


<br />
<br />
<h4 className='strong' style={"fontWeight: bold"}>Leveraging privilege</h4>
...
<br />
<br />
<h4 className='strong' style={"fontWeight: bold"}>Bias towards privilege</h4>
Privileged people knowingly or unknowingly have the bias of assumption. Assuming that everyone is or must be equally privileged as I am. This is unexplored territory they want to explore. This is a curiosity gap that they want to fill in. The preconceived notion of equal privilege lies inherently. It could be because of a lack of past shreds of evidence or lack of data to refer to. Majorly this bias happens towards money more than anything else. It is more evolutionary, I believe. Because in tribes, financially everyone was equally privileged. Obviously, some people had dominance and authority but in terms of materialistic ownership, they all were the same. Which is now what we are seeing in the capitalistic world.

<br />
<br />
<h4 className='strong' style={"fontWeight: bold"}>Going down spiral because of lack of it</h4>
...
<br /><br />
<h4 className='strong' style={"fontWeight: bold"}>Excess privilege</h4>
